    ...
    if (saveBtn) {
        saveBtn.addEventListener("click", async () => {
            ...
            try {
                ...
                // Update badge in the header (optional)
                const badge = document.querySelector(".status-badge");
                if (badge) {
                    badge.className = `status-badge status-${newStatus}`;
                    badge.textContent = newStatus;
                }
                // Also update the share card subtitle if needed
...
// =====================================================
// SHARE FUNCTIONALITY (copied & adapted from admin.js)
// =====================================================
...
function showToast(title, message, type = "success") {
    // Simple alert fallback if toast element not present
    alert(`${title}: ${message}`);
}
